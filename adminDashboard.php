...
<head>
  ...
  <link rel="stylesheet" href="styles/admindas.css" class="src">
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Home Servies</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="adm.php">Sign out</a>
    </div>
  </div>
</header>
